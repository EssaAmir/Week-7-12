...
def login_user(username, password):
    ...
    #Fetching the password hash for the user
    cursor.execute("SELECT password_hash FROM users WHERE username = ?", (username,)) #need to use '?' as it treats the input as just text and not 'code'.
